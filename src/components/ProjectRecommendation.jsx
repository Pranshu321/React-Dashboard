      ...
      <CardContent>
        <Detail>
          <InfoContainer>
            ...
            <Info>
              <InfoName>Pranshu Jain</InfoName>
              <InfoUpdate>Updated 12m ago</InfoUpdate>
            </Info>
          </InfoContainer>
          <Badge content="Design" />
        </Detail>
        <Title>
          Need a WebDeveloepr to form branding essentials like website,web app for your business.
        </Title>
        <ProjectInfo>
        ...
        <PriceContainer>
          <Price>₹ 15000/month</Price>
          <Badge content="Part Time" clean />
        </PriceContainer>
      </CardContent>
    </RecommendProject>
  );
